...
export const tripCreated = functions.firestore.document('trip/{tripId}').onCreate((snap, context) => {
...
export const tripUpdated = functions.firestore.document('trip/{tripId}').onUpdate((change, context) => {
...
export const grantRole = functions.auth.user().onCreate((data, context) => {
    const email = data.email
    const uid = data.uid
    const isContainAdmin = email.includes(adminZ)
